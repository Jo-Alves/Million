    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-10">
          ...
          <div class="form">
            <input class="form-control" type="text" placeholder="Nome..." v-model="fundo.nome" />
            <input
              class="form-control mt-2" type="number"  placeholder="Taxa..." v-model="fundo.taxaRetorno" />
            <input class="form-control mt-2" type="number" placeholder="Indice Infix..." v-model="fundo.indiceInfix" />
            ...
            <router-link to="/fundo-imobiliario" class="btn btn-danger mt-2 p-2 pl-4 pr-4">Cancelar</router-link>
          </div>
        </div>
      </div>
    </div>
